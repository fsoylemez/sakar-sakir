...
public class ComboSolEth2Strategy extends SimpleStrategy {

    private final Integer aroonBarCount;

    private final Integer stochBarCount;

    public ComboSolEth2Strategy(String strategyName, Integer aroonBarCount, Integer stochBarCount) {
        super(strategyName);
    ...
    public Strategy buildStrategy(BarSeries series) {
        ...
        Rule exitRule = new CrossedDownIndicatorRule(aroon.getAroonUpIndicator(), aroon.getAroonDownIndicator())
                ...
                .or(new IsFallingRule(fisher, 2).and(new IsFallingRule(stochK, 2)));
