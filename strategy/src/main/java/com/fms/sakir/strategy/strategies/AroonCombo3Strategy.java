...
public class AroonCombo3Strategy extends SimpleStrategy {
    ...
    public AroonCombo3Strategy(String strategyName, Integer aroonBarCount, Integer cmfBarCount, Integer stochBarCount) {
        super(strategyName);
